...
const skills = [
  ...
  { name: 'HTML', icon: FaHtml5, color: '#61DAFB' },
  { name: 'CSS', icon: FaCss3Alt, color: '#61DAFB' },
  { name: 'TailwindCss', icon: SiTailwindcss, color: '#61DAFB' },
  { name: 'JavaScript', icon: FaJs, color: '#61DAFB' },
  { name: 'Server', icon: FaServer, color: '#61DAFB' },
